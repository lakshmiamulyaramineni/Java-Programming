/*Develop a Java application to generate Electricity bill. Create a class with following members: Consumer no., consumer name, previous month reading,
...
public class ElectricityBill {
    ...
    public static void main (String[] args) {
        Main m = new Main("19BQ1A05J1", "Lakshmi Amulya Ramineni", "Commercial", 5000, 5600);
